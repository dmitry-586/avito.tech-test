...
function withDescription(
  payload: Omit<UpdateItemIn, 'description'>,
...
function mapAutoFormValuesToParams(values: AdEditFormValues): AutoItemParams {
...
export function mapAdEditFormValuesToUpdateItemIn(
  values: AdEditFormValues,
): UpdateItemIn {
