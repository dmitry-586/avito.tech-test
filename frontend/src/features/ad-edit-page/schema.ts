...
export const AD_EDIT_DESCRIPTION_MAX_LENGTH = 3_000
...
export const adEditFormSchema = z.object({
  ...
  description: z
    ...
    .max(
      ...
      `Описание не должно быть длиннее ${AD_EDIT_DESCRIPTION_MAX_LENGTH} символов`,
    ),
...
export type AdEditFormValues = z.infer<typeof adEditFormSchema>

export const AD_EDIT_FORM_DEFAULT_VALUES: AdEditFormValues = {
  category: 'auto',
  title: '',
  price: '',
  description: '',
