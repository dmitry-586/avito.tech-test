...
import type { ImproveDescriptionInput, ImproveDescriptionOutput } from '../validation.ts';
...
export const generateImproveDescription = async (
  ...
  return { message: await generateMessage(buildImproveDescriptionPrompt(input)) };
};
